	...
	public FormLogin() {
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if( (textUsuario.getText().equals("andrea.cruz") && claveFinal.equals("abc123")) || (textUsuario.getText().equals("jostin") && claveFinal.equals("jostin")) || (textUsuario.getText().equals("sofia.morales") && claveFinal.equals("abc123"))) {
					dispose();
					JOptionPane.showMessageDialog(null, "Bienvenido al sistema", "INGRESO EXITOSO", JOptionPane.INFORMATION_MESSAGE);
					String usuario = textUsuario.getText();
					String transaccion = "Usuario Logueado";
