	...
	public PrincipalProcesos() {
		...
		btnAgregar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    String transaccion = "Agrega proceso";
			    //Guarda el registro de la transaccion en el archivo
			    bitacora.guardar(usuario ,transaccion);
			}
		});
		...
		JButton btnMostrarTabla = new JButton("Tabla de Procesos");
		btnMostrarTabla.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MemoriaDinamicaSimulacion  formTabla = new MemoriaDinamicaSimulacion();
				formTabla.setVisible(true);
				formTabla.setListaProcesos(cola);
				dispose();
				
			}
		});
		btnMostrarTabla.setFont(new Font("Lucida Sans Unicode", Font.PLAIN, 11));
		btnMostrarTabla.setBounds(236, 355, 151, 25);
		...
		btnGuardarMemoria.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(textMemoriaTotal.getText().equals("") && textMemoriaSo.getText().equals("")) {
					...
					System.out.println("memorias "+ memoriaTotal + " memoriaSo "+ memoriaSo);
					...
					if(memoriaSo < memoriaTotal) {
						...
						String transaccion = "Agrega memoria y SO";
						System.out.println("Usuario en Pantalla procesos: " + usuario);
						//Guarda el registro de la transaccion en el archivo
						bitacora.guardar(usuario, transaccion);
					}else {
